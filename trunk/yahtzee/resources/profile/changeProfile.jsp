...
<body>
<div id="register">
    <form autocomplete="OFF" name="createUser" action="/profile/ConfirmChangeProfileServlet?orgUser=${userBean.username}" method="post"
        ...
        <table>
            ...
            <tr>
                <td colspan="2"><h:outputText value="#{labels.profileOldPw}"/></td>
                <td><input type="password" name="orgPass" class="text"/></td>
            </tr>
            <tr>
                <td colspan="2"><h:outputText value="#{labels.profileNewPw}"/></td>
                <td><input type="password" name="pw" class="text"/></td>
            </tr>
            <tr>
                <td colspan="2"><h:outputText value="#{labels.profileRePw}"/></td>
            ...
            <tr>
                <td colspan="2">
                    <a href="/profile/ConfirmChangePasswordServlet?user=${userBean.username}"><h:outputText value="#{labels.profilePw}"/></a>
                </td>
                <td>
                    <a href="/profile/ConfirmChangeProfileServlet?user=${userBean.username}"><h:outputText value="#{labels.profileChange}"/></a>
                </td>
            </tr>
            <td colspan="3" align="center" height="40px"><a href="/faces/player/gameRoom.jsp"><h:outputText value="#{labels.gameroomButton}"/></a></td>
            <tr><td colspan="3" align="center">${message}</td></tr>
        </table>
