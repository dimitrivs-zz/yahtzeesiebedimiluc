...
<body>
    ...
    <center>
        <h1>
            <h:outputText value="#{labels.welcomeMessage}"/>
        </h1>
        ...
        <form autocomplete="OFF" name="createUser" action="/register/CreatePlayerServlet" method="post"
            ...
            <table>
                <tr>
                    <th align="right"> <h:outputText value="#{labels.userName}"/></th>
                    <td><input type="text" name="username"/></td>
                </tr>
                <tr>
                    <th align="right"> <h:outputText value="#{labels.password}"/></th>
                    <td><input type="password" name="pw"/></td>
                </tr>
                <tr>
                    <th align="right"> <h:outputText value="#{labels.repeatPassword}"/></th>
                    <td><input type="password" name="pw2"/></td>
                </tr>
                <tr>
                    <th align="right"> <h:outputText value="#{labels.mail}"/></th>
                    <td><input type="text" name="mail"/></td>
                </tr>
                <tr>
                    <th align="right"> <h:outputText value="#{labels.surname}"/></th>
                    <td><input type="text" name="surname"/></td>
                </tr>
                <tr>
                    <th align="right"> <h:outputText value="#{labels.firstname}"/></th>
                    <td><input type="text" name="firstname"/></td>
                </tr>
                <tr>
                    <th align="right"> <h:outputText value="#{labels.telephone}"/></th>
                    <td><input type="text" name="telephone"/></td>
                </tr>
                <tr>
                    <th align="right"> <h:outputText value="#{labels.street}"/></th>
                    <td><input type="text" name="street"/></td>
                </tr>
                <tr>
                    <th align="right"> <h:outputText value="#{labels.number}"/></th>
                    <td><input type="text" name="number"/></td>
                </tr>
                <tr>
                    <th align="right"> <h:outputText value="#{labels.zip}"/></th>
                    <td><input type="text" name="zip"/></td>
                </tr>
                <tr>
                    <th align="right"> <h:outputText value="#{labels.city}"/></th>
                    <td><input type="text" name="city"/></td>
                </tr>
                <tr>
                    <th align="right"> <h:outputText value="#{labels.country}"/></th>
                    <td><input type="text" name="city"/></td>
                </tr>
                <tr>
                    <th colspan=2><input type=submit value="<h:outputText value="#{labels.registerButton}"/>"></th>
                </tr>
                <th colspan="2"><a href="../login/login.html"><h:outputText value="#{labels.inlogButton}"/></a></th>
            </table>
        </form>
    </center>
</body>
