...
public class Game implements java.io.Serializable {
    private be.kdg.yahtzee.remoteObjects.users.User activePlayer;

    private be.kdg.yahtzee.remoteObjects.chat.Chat chat;

    private be.kdg.yahtzee.remoteObjects.users.User creator;

    private java.lang.Object[] diceList;

    private be.kdg.yahtzee.remoteObjects.game.Die[] die;
     ...
     * @return activePlayer
     */
    public be.kdg.yahtzee.remoteObjects.users.User getActivePlayer() {
        return activePlayer;
    }
     ...
     * @param activePlayer
     */
    public void setActivePlayer(be.kdg.yahtzee.remoteObjects.users.User activePlayer) {
        this.activePlayer = activePlayer;
    }
     ...
     * @return chat
     */
    public be.kdg.yahtzee.remoteObjects.chat.Chat getChat() {
        return chat;
    }
     ...
     * @param chat
     */
    public void setChat(be.kdg.yahtzee.remoteObjects.chat.Chat chat) {
        this.chat = chat;
    }
     ...
     * @return creator
     */
    public be.kdg.yahtzee.remoteObjects.users.User getCreator() {
        return creator;
    }
     ...
     * @param creator
     */
    public void setCreator(be.kdg.yahtzee.remoteObjects.users.User creator) {
        this.creator = creator;
    }
     ...
     * @return die
     */
    public be.kdg.yahtzee.remoteObjects.game.Die[] getDie() {
        return die;
    }
     ...
     * @param die
     */
    public void setDie(be.kdg.yahtzee.remoteObjects.game.Die[] die) {
        this.die = die;
    }

    public be.kdg.yahtzee.remoteObjects.game.Die getDie(int i) {
        return this.die[i];
    }

    public void setDie(int i, be.kdg.yahtzee.remoteObjects.game.Die _value) {
        this.die[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://game.remoteObjects.yahtzee.kdg.be", "Game"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://chat.remoteObjects.yahtzee.kdg.be", "Chat"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://game.remoteObjects.yahtzee.kdg.be", "Die"));
        elemField.setNillable(true);
