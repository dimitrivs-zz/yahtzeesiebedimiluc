...
public class YahtzeeControllerServiceLocator extends org.apache.axis.client.Service implements be.kdg.yahtzee.remoteObjects.YahtzeeControllerService {
    ...
    public be.kdg.yahtzee.remoteObjects.YahtzeeController getyahtzee(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            be.kdg.yahtzee.remoteObjects.YahtzeeSoapBindingStub _stub = new be.kdg.yahtzee.remoteObjects.YahtzeeSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (be.kdg.yahtzee.remoteObjects.YahtzeeController.class.isAssignableFrom(serviceEndpointInterface)) {
                be.kdg.yahtzee.remoteObjects.YahtzeeSoapBindingStub _stub = new be.kdg.yahtzee.remoteObjects.YahtzeeSoapBindingStub(new java.net.URL(yahtzee_address), this);
                _stub.setPortName(getyahtzeeWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://remoteObjects.yahtzee.kdg.be", "YahtzeeControllerService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://remoteObjects.yahtzee.kdg.be", "yahtzee"));
        }
