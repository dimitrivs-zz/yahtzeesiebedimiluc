        ...
        <form autocomplete="OFF" name="createUser" action="/register/CreatePlayerServlet" method="post"
            ...
            <table>
                <tr>
                    ...
                    <td><h1>
                        <h:outputText value="#{labels.register}"/>
                    </h1></td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    <td height="40px"><input type="submit" value="<h:outputText value="#{labels.registerButton}"/>"
                                             class="btn"></td>
                </tr>
                <tr>
                    <td colspan="3" align="center" height="35px"><a href="../login/login.jsp" class="back">
