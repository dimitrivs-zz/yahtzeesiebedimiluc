...
public class Highscore implements java.io.Serializable {
    ...
    private be.kdg.yahtzee.model.remoteObjects.users.User user;
    ...
    public Highscore(
            ...
            be.kdg.yahtzee.model.remoteObjects.users.User user) {
     ...
     * @return user
     */
    public be.kdg.yahtzee.model.remoteObjects.users.User getUser() {
        return user;
    }
     ...
     * @param user
     */
    public void setUser(be.kdg.yahtzee.model.remoteObjects.users.User user) {
        this.user = user;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://game.remoteObjects.model.yahtzee.kdg.be", "Highscore"));
