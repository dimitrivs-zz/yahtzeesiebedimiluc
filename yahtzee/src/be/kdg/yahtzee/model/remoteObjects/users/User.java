...
public class User implements java.io.Serializable {
    ...
    private be.kdg.yahtzee.model.remoteObjects.users.Person person;

    private be.kdg.yahtzee.model.remoteObjects.users.Role role;
    ...
    public User(
            ...
            be.kdg.yahtzee.model.remoteObjects.users.Person person,
            be.kdg.yahtzee.model.remoteObjects.users.Role role,
     ...
     * @return person
     */
    public be.kdg.yahtzee.model.remoteObjects.users.Person getPerson() {
        return person;
    }
     ...
     * @param person
     */
    public void setPerson(be.kdg.yahtzee.model.remoteObjects.users.Person person) {
        this.person = person;
    }
     ...
     * @return role
     */
    public be.kdg.yahtzee.model.remoteObjects.users.Role getRole() {
        return role;
    }
     ...
     * @param role
     */
    public void setRole(be.kdg.yahtzee.model.remoteObjects.users.Role role) {
        this.role = role;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://users.remoteObjects.model.yahtzee.kdg.be", "User"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://users.remoteObjects.model.yahtzee.kdg.be", "Person"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("role");
        elemField.setXmlName(new javax.xml.namespace.QName("", "role"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://users.remoteObjects.model.yahtzee.kdg.be", "Role"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
