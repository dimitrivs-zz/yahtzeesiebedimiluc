...
public class TestScore {
    ...
    public void testYahtzee(){
        ...
        assertEquals("Totaal van Yahtzee moet <50> zijn", 50, score.getYahtzee());
        assertTrue("Yahtzee moeten <fixed> zijn", score.isYahtzeeFixed());
        assertEquals("Totaal van YahtzeeBonus moet <100> zijn", 100, score.getYahtzeeBonus());
    }
    ...
    @Test
    public void testGameTotalsWithBonus(){
        score.setOnes(3);
        score.setTwos(8);
        score.setThrees(6);
        score.setFours(12);
        ...
        assertEquals("Totaal van de bovenste helft moet <98> zijn", 98, score.getTotalUpperHalf());

        score.setThreeOfAKind(19);
        score.setCarre(21);
        score.setFullHouse(25);
        score.setSmallStreet(30);
        score.setLargeStreet(0);
        score.setYahtzee(50);
        score.setChance(25);

        assertEquals("Totaal van de onderste helft moet <170> zijn", 170, score.getTotalLowerHalf());

        assertEquals("Totaal van het spel moet <268> zijn", 268, score.getTotalScore());
    }

    @Test
    public void testGameTotalsWithoutBonus(){
        score.setOnes(3);
        score.setTwos(8);
        score.setThrees(6);
        score.setFours(12);
        ...
        assertEquals("Totaal van de bovenste helft moet <57> zijn", 57, score.getTotalUpperHalf());
